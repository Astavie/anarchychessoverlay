// ==UserScript==
// @name         anarchychess template
// @namespace    http://tampermonkey.net/
// @version      0.8
// @description  try to take over the canvas!
// @author       Astavie (OSU team: oralekin, LittleEndu, ekgame, Wieku, DeadRote, exdeejay (xDJ_), 101arrowz)
...
if (window.top !== window.self) {
    window.addEventListener('load', () => {
        ...
        const full = "https://raw.githubusercontent.com/Astavie/anarchychessoverlay/main/overlay.png";
